...
def controls():
    ...
    p_key = pygame.transform.scale(pygame.image.load("assets/p.png"), (40, 40))
    ...
    while True:
        ...
        select_rect = select_text.get_rect(center=(475, 250))
        window.blit(select_text, select_rect)

        window.blit(a_key, (250, 230)) 
        window.blit(d_key, (200, 230)) 

        # Render "Craft items"
        craft_text = pygame.font.Font(None, 28).render("Craft Items at Fireplace", True, (255, 255, 255))
        craft_rect = craft_text.get_rect(center=(450, 345))
        window.blit(craft_text, craft_rect)

        window.blit(c_key, (225, 325)) 
        
        # Render "Discard items"
        discard_text = pygame.font.Font(None, 28).render("Discard Item at Bin", True, (255, 255, 255))
        discard_rect = discard_text.get_rect(center=(450, 445))
        window.blit(discard_text, discard_rect)

        window.blit(spacebar, (185, 385))

        # Render "Pause game"
        pause_text = pygame.font.Font(None, 28).render("Pause Game", True, (255,255,255))
        pause_rect = pause_text.get_rect(center=(450, 545))
        window.blit(pause_text, pause_rect)

        window.blit(p_key, (225, 525))
